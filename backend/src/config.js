...
const namePrefix = "Loveher.io";
const description = "This is a story about her.";
...
const extraMetadata = {
  external_url: "https://loveher.io", // Replace with your website or remove this line if you do not have one.
};
...
const PUBLIC_MINT_START_DATE = "2022-08-28T17:30:00+08:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00 UTC Time +8 SG Time 
...
const PRESALE_WHITELISTED_ADDRESSES = ["0x69190865da67Cc088CC1f012EDf197E6eA286b59","","",""]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_DESCRIPTION = "Who will you love?"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeihtgu7isqfz6ruq5rnagpf65iiyncqudetstqprxhn764grvngyny"; // Replace with your generic image that will display for all NFTs pre-reveal.
